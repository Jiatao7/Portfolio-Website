    ...
    return (
        <div className="py-20">
            <div className="text-center mb-8">
                ...
                <p className="text-xs"> Feel free to contact me if you have any questions<span className="text-primary">.</span></p>
            </div>
            <form method="post" className="max-w-md mx-auto grid gap-2 px-6">
                ...
                <Textarea className="min-h-[100px]" autocomplete="off" id="message" placeholder="..."></Textarea>
