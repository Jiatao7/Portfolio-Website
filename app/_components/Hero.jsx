...
export default function Hero() {
    return (
        <section className='relative grid place-content-center py-20 px-6'>
            <div className='md:max-w-3xl max-w-md text-center grid gap-1'>
                <h1 className='md:text-4xl lg:text-5xl text-3xl font-bold'>
                    Hi I am <span className='underline underline-offset-4 text-primary'>Jiatao Geng</span> an aspiring Software Engineer<span className='text-primary'>.</span>
                </h1>
            ...
            <div className='flex items-center justify-center gap-3 mt-10'>
                ...
                <Button asChild className="flex gap-1 items-center justify-center">
                    <Link href="https://github.com/Jiatao7">My Github</Link>
                </Button>
            </div>
        </section>
    )
